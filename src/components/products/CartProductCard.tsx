...
import { Button, Card, CardBody, HStack, IconButton, Image, Text } from "@chakra-ui/react"
...
const CartProductCard: FC<ProductInformation> = ({ image, price, title }): JSX.Element => {
    ...
    return (
        <Card direction='row' bgColor='gray.50' h='36'>
            <Image loading='lazy' src={image} alt={title} w='36' h='36' objectFit='cover' borderLeftRadius='md' />
            <CardBody w={[48, 80, 96]}>
