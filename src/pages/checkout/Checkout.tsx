...
import { OrderSummary, PaymentInformation, ShippingInformation } from '@/components/checkout'
    ...
    <>
      ...
      <Box bgGradient={useColorModeValue('linear(to-l, gray.50 50%, white 50%)', 'linear(to-l, gray.700 50%, gray.800 50%)')} minH='100vh'>
        <Flex maxW="8xl" mx="auto" direction={{ base: 'column', md: 'row' }}>
          ...
          <Box flex="1" maxW={{ lg: 'md', xl: '40rem' }} bg='gray.50' px={{ base: '4', md: '8', lg: '12', xl: '20' }} py={{ base: '6', md: '8', lg: '12', xl: '20' }}>
            <OrderSummary />
          </Box>
        </Flex>
      </Box>
